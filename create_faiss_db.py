...
if __name__ == '__main__':
    ...
    parser.add_argument('--output_faiss_db', default="mwoz_db.pkl")
    ...
    parser.add_argument('--total', default=20, type=int)
    ...
    if args.dataset == 'multiwoz':
        ...
        data_gen = load_mwoz(args.database_path, args.context_size, split=args.split, total=args.total, available_domains=available_domains, shuffle=True, only_single_domain=False)
    docs = []
